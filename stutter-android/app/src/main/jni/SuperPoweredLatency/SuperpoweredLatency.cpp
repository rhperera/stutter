...
extern "C" {
    JNIEXPORT void Java_com_scorelab_stutteraid_LatencyTestActivity_SuperpoweredLatency(JNIEnv *javaEnvironment, jobject self, jlong _samplerate, jlong _buffersize);
    JNIEXPORT void Java_com_scorelab_stutteraid_LatencyTestActivity_toggleMeasurer(JNIEnv *javaEnvironment, jobject self);
    JNIEXPORT void Java_com_scorelab_stutteraid_LatencyTestActivity_togglePassThrough(JNIEnv *javaEnvironment, jobject self);
    JNIEXPORT int Java_com_scorelab_stutteraid_LatencyTestActivity_getState(JNIEnv *javaEnvironment, jobject self);
    JNIEXPORT int Java_com_scorelab_stutteraid_LatencyTestActivity_getLatencyMs(JNIEnv *javaEnvironment, jobject self);
    JNIEXPORT int Java_com_scorelab_stutteraid_LatencyTestActivity_getSamplerate(JNIEnv *javaEnvironment, jobject self);
    JNIEXPORT int Java_com_scorelab_stutteraid_LatencyTestActivity_getBuffersize(JNIEnv *javaEnvironment, jobject self);
}

JNIEXPORT void Java_com_scorelab_stutteraid_LatencyTestActivity_toggleMeasurer(JNIEnv *javaEnvironment, jobject self) { measurer->toggle(); }
JNIEXPORT void Java_com_scorelab_stutteraid_LatencyTestActivity_togglePassThrough(JNIEnv *javaEnvironment, jobject self) { measurer->togglePassThrough(); }
JNIEXPORT int Java_com_scorelab_stutteraid_LatencyTestActivity_getState(JNIEnv *javaEnvironment, jobject self) { return measurer->state; }
JNIEXPORT int Java_com_scorelab_stutteraid_LatencyTestActivity_getLatencyMs(JNIEnv *javaEnvironment, jobject self) { return measurer->latencyMs; }
JNIEXPORT int Java_com_scorelab_stutteraid_LatencyTestActivity_getSamplerate(JNIEnv *javaEnvironment, jobject self) { return measurer->samplerate; }
JNIEXPORT int Java_com_scorelab_stutteraid_LatencyTestActivity_getBuffersize(JNIEnv *javaEnvironment, jobject self) { return measurer->buffersize; }
