...
extern "C" {
JNIEXPORT void Java_com_superpowered_superpoweredlatency_AudioIO_SuperpoweredLatency(JNIEnv *javaEnvironment, jobject self, jlong _samplerate, jlong _buffersize);
JNIEXPORT void Java_com_superpowered_superpoweredlatency_AudioIO_toggleMeasurer(JNIEnv *javaEnvironment, jobject self);
JNIEXPORT void Java_com_superpowered_superpoweredlatency_AudioIO_togglePassThrough(JNIEnv *javaEnvironment, jobject self);
JNIEXPORT int Java_com_superpowered_superpoweredlatency_AudioIO_getState(JNIEnv *javaEnvironment, jobject self);
JNIEXPORT int Java_com_superpowered_superpoweredlatency_AudioIO_getLatencyMs(JNIEnv *javaEnvironment, jobject self);
JNIEXPORT int Java_com_superpowered_superpoweredlatency_AudioIO_getSamplerate(JNIEnv *javaEnvironment, jobject self);
JNIEXPORT int Java_com_superpowered_superpoweredlatency_AudioIO_getBuffersize(JNIEnv *javaEnvironment, jobject self);
}

JNIEXPORT void Java_com_superpowered_superpoweredlatency_AudioIO_toggleMeasurer(JNIEnv *javaEnvironment, jobject self) { measurer->toggle(); }
JNIEXPORT void Java_com_superpowered_superpoweredlatency_AudioIO_togglePassThrough(JNIEnv *javaEnvironment, jobject self) { measurer->togglePassThrough(); }
JNIEXPORT int Java_com_superpowered_superpoweredlatency_AudioIO_getState(JNIEnv *javaEnvironment, jobject self) { return measurer->state; }
JNIEXPORT int Java_com_superpowered_superpoweredlatency_AudioIO_getLatencyMs(JNIEnv *javaEnvironment, jobject self) { return measurer->latencyMs; }
JNIEXPORT int Java_com_superpowered_superpoweredlatency_AudioIO_getSamplerate(JNIEnv *javaEnvironment, jobject self) { return measurer->samplerate; }
JNIEXPORT int Java_com_superpowered_superpoweredlatency_AudioIO_getBuffersize(JNIEnv *javaEnvironment, jobject self) { return measurer->buffersize; }
