...
//                    }
                    ...
                    String text = _latencyMs + "ms";
                    int duration = Toast.LENGTH_SHORT;
                    TextView conclusionText = (TextView)findViewById(R.id.conclusion);
                    conclusionText.setVisibility(View.VISIBLE);
                    long trueLatency = _latencyMs + 40;
                    if(trueLatency < 50){
                        conclusionText.setText("You device will do best");
                    }
                    else if(trueLatency < 100 && trueLatency > 50){
                        conclusionText.setText("Your device will do good, with a small amount of slowness in speech");
                    }
                    else if (trueLatency < 200 && trueLatency > 100){
                        conclusionText.setText("The app will let you talk very slow.");
                    }
                    else if(trueLatency > 200){
                        conclusionText.setText("Your device is not suited");
                    }
                    else{
                        conclusionText.setText("Your device is not suited");
                    }
